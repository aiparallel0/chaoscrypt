...
P1 = [
    ...
    ("bul", "Introduction: chaos image ciphers keep breaking the same way", [
        ...
        ("Second problem (method): schemes are judged by statistics: entropy (a randomness score), "
         "neighbouring-pixel correlation, NPCR/UACI. Near-ideal values are treated as proof of "
         "security.", 0),
    ...
    ("bul", "Selected references", [
        ("J. Jain et al., LLEO chaos-based image-encryption scheme, Optik 327:172304, 2025  (target scheme).", 0),
