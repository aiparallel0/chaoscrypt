...
intrinsic flaw of the models. The value of abstention, however, persists under drift. Training on
...
cheap drift signal instead of trusting the raw probabilities. The reject option should be paired with a
